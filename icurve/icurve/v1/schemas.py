...
DefinitionsBanditems = {'xml': {'wrapped': True, 'name': 'band'}, 'items': {'required': ['bandNo', 'bandCount', 'currentTime', 'reliablity'], 'properties': {'nextTime': DefinitionsTimeslot, 'bandCount': {'type': 'integer', 'format': 'int64'}, 'preTime': DefinitionsTimeslot, 'reliablity': {'type': 'number', 'description': u'\u63cf\u8ff0\u6240\u751f\u6210 band \u7684\u53ef\u4fe1\u7a0b\u5ea6', 'format': 'float'}, 'bandNo': {'type': 'integer', 'format': 'int64'}, 'currentTime': DefinitionsBandtime}}, 'type': 'array'}
DefinitionsBandcategory = {'required': ['name', 'bands'], 'properties': {'bands': DefinitionsBanditems, 'name': {'type': 'string'}}}
DefinitionsBandresponse = {'required': ['data'], 'allOf': [DefinitionsCommonresponse, {'properties': {'data': DefinitionsBanditems}}]}
DefinitionsTrendresponse = {'required': ['data'], 'allOf': [DefinitionsCommonresponse, {'properties': {'data': {'required': ['trends', 'bands', 'yAxis'], 'properties': {'bands': {'items': DefinitionsBandcategory, 'type': 'array'}, 'trends': {'items': DefinitionsTrend, 'type': 'array'}, 'yAxis': {'xml': {'wrapped': True, 'name': 'value'}, 'minItems': 2, 'type': 'array', 'maxItems': 2, 'items': {'type': 'number', 'format': 'float'}}}}}}]}
